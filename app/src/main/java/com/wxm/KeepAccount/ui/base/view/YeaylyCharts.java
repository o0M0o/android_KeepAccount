 ...
 */
public class YeaylyCharts extends ChartsBase {
    final private static String TAG = "YeaylyCharts";

    public YeaylyCharts(Context context)  {
        super(context);
        chartTitle = "年统计";
        subChartTitle = "(年收支统计)";
    }

    public YeaylyCharts(Context context, AttributeSet attrs){
        super(context, attrs);
        chartTitle = "年统计";
        subChartTitle = "(年收支统计)";
    }

    public YeaylyCharts(Context context, AttributeSet attrs, int defStyle) {
