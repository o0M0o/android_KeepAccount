...
public class PayRecordActivity extends AppCompatActivity implements View.OnTouchListener {
        ...
        switch (item.getItemId()) {
            case R.id.paymenu_save:
            {
                ...
                if(str_date.isEmpty())
                {
                    Log.i(TAG, "支出日期为空");
                    AlertDialog.Builder builder = new AlertDialog.Builder(this);
                    builder.setMessage("支出日期为空,请输入支出日期!")
                            .setTitle("警告");
                ...
                data.putExtra(res.getString(R.string.pay_date), str_date);
