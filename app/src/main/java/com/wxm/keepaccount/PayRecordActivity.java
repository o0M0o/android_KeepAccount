...
public class PayRecordActivity extends AppCompatActivity {
    ...
    public void onClickOk(View view)    {
        ...
        String et_val = ((EditText)this.findViewById(R.id.ed_pay_amount)).getText().toString();
        String et_type = ((EditText)this.findViewById(R.id.ed_pay_type)).getText().toString();
        if(et_val.isEmpty())
        {
            Log.i(TAG, "支出数值为空");
