package wxm.calendarlv_library;
...
public class PinnedHeaderListView extends ListView implements OnScrollListener {
    ...
    public void onScrollStateChanged(AbsListView view, int scrollState) {
        if (mOnScrollListeners != null && mOnScrollListeners.size() > 0) {
            OnScrollListener[] arr_items = new OnScrollListener[mOnScrollListeners.size()];
            mOnScrollListeners.toArray(arr_items);

            for (OnScrollListener item : arr_items) {
